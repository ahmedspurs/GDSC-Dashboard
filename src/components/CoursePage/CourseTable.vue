<template>
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      >
        <tr>
          <th scope="col" class="px-6 py-3">رقم الكورس </th>
...
import EditCourseInput from "../EditCourse/EditCourseInput.vue";
...
export default {
  ...
  components: { EditCourseInput, VueFinalModal },
  computed: {
