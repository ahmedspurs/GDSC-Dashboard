...
const data = {
  ...
  courseId : this.courseId
      ...
      if (await this.$store.dispatch("addCetrtificate", data)) {
        this.responseAlert("تمت إضافة الشهادة بنجاح", "تم", "success");
      } else {
        this.responseAlert(" حدث خطاء اثناء اضافة الشهادة ", "عفوا", "error");
      }
      loader.hide();
